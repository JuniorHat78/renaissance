...
//
// Text -> AST: the document tokenizer, the inline tokenizer, the document
// validator, and the legacy-blocks bridge. This is the code P5 stops shipping to
// the reader. It depends on core and, on load, registers itself as core's string
// parser and legacy converter so normalizeAstInput can accept raw input in Node.
// In Node it is folded into ast/index.js. See docs/specs/AST-COMPILER.md.
(function initRenaissanceAstParse(root, factory) {
  if (typeof module === "object" && module.exports) {
    module.exports = factory(require("./core.js"));
  } else {
    root.RenaissanceAst = Object.assign(root.RenaissanceAst || {}, factory(root.RenaissanceAst));
  }
})(typeof globalThis !== "undefined" ? globalThis : window, function buildRenaissanceAstParse(core) {
  "use strict";
  ...
  core.registerLegacyConverter(legacyBlocksToAst);
